...
RUN [ ${BUILDLEV} = "base" || ${BUILDLEV} = "full" ] && sudo sh /var/www/html/shell/setup/this/vnc-wine.sh ${UBUNTUVER} "nowine" 
RUN [ ${BUILDLEV} = "base" || ${BUILDLEV} = "full"  ] && sudo sh /var/www/html/shell/setup/this/u7php.sh ${UBUNTUVER} 
